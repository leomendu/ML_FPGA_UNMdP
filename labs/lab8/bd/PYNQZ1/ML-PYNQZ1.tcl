...
\
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins inference_0/s_axi_control] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net comblock_0_fifo_data_o [get_bd_pins comblock_0/fifo_data_i] [get_bd_pins comblock_0/fifo_data_o] [get_bd_pins inference_0/input_r_TDATA]
  connect_bd_net -net comblock_0_fifo_valid_o [get_bd_pins comblock_0/fifo_valid_o] [get_bd_pins comblock_0/fifo_we_i] [get_bd_pins inference_0/input_r_TVALID]
  connect_bd_net -net comblock_0_reg0_o [get_bd_pins comblock_0/reg0_i] [get_bd_pins comblock_0/reg0_o]
  connect_bd_net -net inference_0_result [get_bd_pins comblock_0/reg1_i] [get_bd_pins inference_0/result]
  connect_bd_net -net inference_0_result_ap_vld [get_bd_pins comblock_0/reg2_i] [get_bd_pins inference_0/result_ap_vld]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins comblock_0/axil_aclk] [get_bd_pins comblock_0/fifo_clk_i] [get_bd_pins inference_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins comblock_0/axil_aresetn] [get_bd_pins inference_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs inference_0/s_axi_control/Reg] -force
